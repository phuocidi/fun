...
function submitFeedback(){var feedbackData={rating:getRating(),tags:getCheckedCommentTags(),additionalUserComment:getEnteredComment()};jQuery(".process").html('Saving...');jQuery.ajax({url:utilUrl+"gfg/saveFeedback.php",method:"POST",data:{post_id:post_id,rating:feedbackData.rating,tags:feedbackData.tags,comments:feedbackData.additionalUserComment},xhrFields:{withCredentials:!0},success:function(responseData){showFeedbackMessage();if(jQuery(".feedbackButton").html()=="Give Feedback"){jQuery(".feedbackButton").html('Edit your Feedback')}},error:function(responseData,textStatus){showFeedbackMessage();console.log('HTTP Status : '+textStatus)}})}
...
feedbackRating=loginData.feedbackRating;feedbackComment=loginData.feedbackComment;feedbackTags=loginData.feedbackTags}else{document.getElementById("improveArticle").innerHTML="<a class='login-modal-btn' style='color:#060' href='"+authUrl+"?to="+post_slug+"'>Login to Improve this Article</a>";document.getElementById("feedbackButtonDiv").innerHTML='<button class="feedbackButton">Feedback</button><button class="feedbackButton">Add Notes</button><button class="feedbackButton">Improve Article</button>';jQuery(".plugins").addClass("noLogInPlugins");jQuery(".plugins").removeClass("plugins");document.getElementById("insideLoginSpanText").innerHTML="<a class='login-modal-btn' href='"+authUrl+"?to="+post_slug+"'>Login to Use</a>"}
